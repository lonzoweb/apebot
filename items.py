...
ITEM_REGISTRY = {
    ...
    "uwu": {
        ...
        "duration_sec": 1800,  # 30 mins
        "type": "curse",
        "shop_desc": "Forces target to speak in uwu-speak for 30 minutes.",
...
ITEM_ALIASES = {
    ...
    "mirror": "reversal_ward",
    "max_ward": "reversal_ward",
    "ward max": "reversal_ward",
    "echo max": "reversal_ward",
    "eco max": "reversal_ward",
    "echo ward max": "reversal_ward",
    "reversal_ward": "reversal_ward",
    "reversal": "reversal_ward",
    "echo_seal": "echo_seal",
    "echo seal": "echo_seal",
    "seal": "echo_seal",
    "obsidian": "echo_seal",
